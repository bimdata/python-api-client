...
# **create_rule**
> Rule create_rule(check_plan_pk, project_pk, ruleset_pk, cloud_pk, data)
...
try:
    api_response = api_instance.create_rule(check_plan_pk, project_pk, ruleset_pk, cloud_pk, data)
    pprint(api_response)
except ApiException as e:
...
> RuleComponent create_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, check_plan_pk, data)
...
try:
    api_response = api_instance.create_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, check_plan_pk, data)
    pprint(api_response)
except ApiException as e:
...
> delete_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id)
...
try:
    api_instance.delete_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id)
except ApiException as e:
...
# **delete_checker**
> delete_checker(ifc_pk, project_pk, id, cloud_pk)
...
try:
    api_instance.delete_checker(ifc_pk, project_pk, id, cloud_pk)
except ApiException as e:
...
# **delete_rule**
> delete_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk)
...
try:
    api_instance.delete_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk)
except ApiException as e:
...
> delete_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk)
...
try:
    api_instance.delete_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk)
except ApiException as e:
...
> CheckPlanResult full_update_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id, data)
...
try:
    api_response = api_instance.full_update_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_checker**
> IfcChecker full_update_checker(ifc_pk, project_pk, id, cloud_pk, data)
...
try:
    api_response = api_instance.full_update_checker(ifc_pk, project_pk, id, cloud_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_rule**
> Rule full_update_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk, data)
...
try:
    api_response = api_instance.full_update_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk, data)
    pprint(api_response)
except ApiException as e:
...
> RuleComponent full_update_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk, data)
...
try:
    api_response = api_instance.full_update_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk, data)
    pprint(api_response)
except ApiException as e:
...
> CheckPlanResult get_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id)
...
try:
    api_response = api_instance.get_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_checker**
> IfcChecker get_checker(ifc_pk, project_pk, id, cloud_pk)
...
try:
    api_response = api_instance.get_checker(ifc_pk, project_pk, id, cloud_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_rule**
> Rule get_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk)
...
try:
    api_response = api_instance.get_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_rule_component**
> RuleComponent get_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk)
...
try:
    api_response = api_instance.get_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_rule_components**
> list[RuleComponent] get_rule_components(project_pk, ruleset_pk, rule_pk, cloud_pk, check_plan_pk)
...
try:
    api_response = api_instance.get_rule_components(project_pk, ruleset_pk, rule_pk, cloud_pk, check_plan_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_rules**
> list[Rule] get_rules(check_plan_pk, project_pk, ruleset_pk, cloud_pk)
...
try:
    api_response = api_instance.get_rules(check_plan_pk, project_pk, ruleset_pk, cloud_pk)
    pprint(api_response)
except ApiException as e:
...
# **launch_new_check**
> launch_new_check(ifc_pk, project_pk, id, cloud_pk, data)
...
try:
    api_instance.launch_new_check(ifc_pk, project_pk, id, cloud_pk, data)
except ApiException as e:
...
> CheckPlanResult update_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id, data)
...
try:
    api_response = api_instance.update_check_plan_result(ifc_pk, project_pk, checker_pk, cloud_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_checker**
> IfcChecker update_checker(ifc_pk, project_pk, id, cloud_pk, data)
...
try:
    api_response = api_instance.update_checker(ifc_pk, project_pk, id, cloud_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_rule**
> Rule update_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk, data)
...
try:
    api_response = api_instance.update_rule(project_pk, ruleset_pk, cloud_pk, id, check_plan_pk, data)
    pprint(api_response)
except ApiException as e:
...
> RuleComponent update_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk, data)
...
try:
    api_response = api_instance.update_rule_component(project_pk, ruleset_pk, rule_pk, cloud_pk, id, check_plan_pk, data)
    pprint(api_response)
except ApiException as e:
