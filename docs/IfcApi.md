...
> list[Element] bulk_full_update_elements(project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.bulk_full_update_elements(project_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> list[ModelProperty] bulk_full_update_ifc_property(project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.bulk_full_update_ifc_property(project_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> bulk_remove_elements_from_classification(project_pk, cloud_pk, ifc_pk, ifc_classification_pk)
...
try:
    api_instance.bulk_remove_elements_from_classification(project_pk, cloud_pk, ifc_pk, ifc_classification_pk)
except ApiException as e:
...
> list[Element] bulk_update_elements(project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.bulk_update_elements(project_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> list[ModelProperty] bulk_update_ifc_property(project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.bulk_update_ifc_property(project_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> ModelProperty create_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.create_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition create_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.create_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> Unit create_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.create_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **create_raw_elements**
> create_raw_elements(project_pk, cloud_pk, ifc_pk, data)
...
try:
    api_instance.create_raw_elements(project_pk, cloud_pk, ifc_pk, data)
except ApiException as e:
...
# **create_zone_space**
> ZoneSpace create_zone_space(project_pk, cloud_pk, zone_pk, ifc_pk, data)
...
try:
    api_response = api_instance.create_zone_space(project_pk, cloud_pk, zone_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **delete_ifc_property**
> delete_ifc_property(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_ifc_property(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> delete_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
# **delete_ifc_unit**
> delete_ifc_unit(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_ifc_unit(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
# **delete_property_set**
> delete_property_set(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_property_set(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
# **delete_space**
> delete_space(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_space(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
# **delete_zone**
> delete_zone(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.delete_zone(project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
# **full_update_element**
> Element full_update_element(project_pk, uuid, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.full_update_element(project_pk, uuid, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> ModelProperty full_update_ifc_property(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_ifc_property(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition full_update_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> Unit full_update_ifc_unit(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_ifc_unit(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> PropertySet full_update_property_set(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_property_set(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_space**
> Space full_update_space(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_space(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_zone**
> Zone full_update_zone(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.full_update_zone(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **get_element**
> Element get_element(project_pk, uuid, cloud_pk, ifc_pk)
...
try:
    api_response = api_instance.get_element(project_pk, uuid, cloud_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
> PropertySet get_element_property_set(element_uuid, project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_element_property_set(element_uuid, project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
> list[ModelProperty] get_element_property_set_properties(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk)
...
try:
    api_response = api_instance.get_element_property_set_properties(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
> ModelProperty get_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition get_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
> Unit get_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
> list[Unit] get_element_property_set_property_definition_units(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk)
...
try:
    api_response = api_instance.get_element_property_set_property_definition_units(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
> list[PropertyDefinition] get_element_property_set_property_definitions(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk)
...
try:
    api_response = api_instance.get_element_property_set_property_definitions(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
> list[Element] get_elements_from_classification(project_pk, cloud_pk, ifc_pk, ifc_classification_pk)
...
try:
    api_response = api_instance.get_elements_from_classification(project_pk, cloud_pk, ifc_pk, ifc_classification_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_ifc_property**
> ModelProperty get_ifc_property(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_ifc_property(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition get_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_ifc_unit**
> Unit get_ifc_unit(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_ifc_unit(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_property_set**
> PropertySet get_property_set(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_property_set(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_raw_elements**
> get_raw_elements(project_pk, cloud_pk, ifc_pk)
...
try:
    api_instance.get_raw_elements(project_pk, cloud_pk, ifc_pk)
except ApiException as e:
...
# **get_space**
> Space get_space(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_space(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_zone**
> Zone get_zone(project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_response = api_instance.get_zone(project_pk, cloud_pk, ifc_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_zone_spaces**
> list[ZoneSpace] get_zone_spaces(project_pk, cloud_pk, zone_pk, ifc_pk)
...
try:
    api_response = api_instance.get_zone_spaces(project_pk, cloud_pk, zone_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
> remove_classification_of_element(element_uuid, project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.remove_classification_of_element(element_uuid, project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> remove_element_property_set(element_uuid, project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.remove_element_property_set(element_uuid, project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> remove_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.remove_element_property_set_property(element_uuid, propertyset_pk, project_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> remove_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.remove_element_property_set_property_definition(element_uuid, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> remove_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
...
try:
    api_instance.remove_element_property_set_property_definition_unit(element_uuid, propertydefinition_pk, propertyset_pk, project_pk, property_pk, cloud_pk, ifc_pk, id)
except ApiException as e:
...
> remove_elements_from_classification(project_pk, uuid, cloud_pk, ifc_pk, ifc_classification_pk)
...
try:
    api_instance.remove_elements_from_classification(project_pk, uuid, cloud_pk, ifc_pk, ifc_classification_pk)
except ApiException as e:
...
# **update_element**
> Element update_element(project_pk, uuid, cloud_pk, ifc_pk, data)
...
try:
    api_response = api_instance.update_element(project_pk, uuid, cloud_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_ifc_property**
> ModelProperty update_ifc_property(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_ifc_property(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition update_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_ifc_property_definition(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_ifc_unit**
> Unit update_ifc_unit(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_ifc_unit(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_property_set**
> PropertySet update_property_set(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_property_set(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_space**
> Space update_space(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_space(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_zone**
> Zone update_zone(project_pk, cloud_pk, ifc_pk, id, data)
...
try:
    api_response = api_instance.update_zone(project_pk, cloud_pk, ifc_pk, id, data)
    pprint(api_response)
except ApiException as e:
