...
> bulk_remove_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk)
...
try:
    api_instance.bulk_remove_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk)
except ApiException as e:
...
> bulk_remove_elements_from_classification(ifc_classification_pk, cloud_pk, ifc_pk, project_pk)
...
try:
    api_instance.bulk_remove_elements_from_classification(ifc_classification_pk, cloud_pk, ifc_pk, project_pk)
except ApiException as e:
...
> list[Classification] create_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk, data)
...
try:
    api_response = api_instance.create_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> create_element_property_set(element_uuid, cloud_pk, ifc_pk, project_pk, data)
...
try:
    api_instance.create_element_property_set(element_uuid, cloud_pk, ifc_pk, project_pk, data)
except ApiException as e:
...
> ModelProperty create_element_property_set_property(cloud_pk, project_pk, propertyset_pk, ifc_pk, element_uuid, data)
...
try:
    api_response = api_instance.create_element_property_set_property(cloud_pk, project_pk, propertyset_pk, ifc_pk, element_uuid, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition create_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid, data)
...
try:
    api_response = api_instance.create_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid, data)
    pprint(api_response)
except ApiException as e:
...
> Unit create_element_property_set_property_definition_unit(cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid, data)
...
try:
    api_response = api_instance.create_element_property_set_property_definition_unit(cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid, data)
    pprint(api_response)
except ApiException as e:
...
# **create_zone_space**
> ZoneSpace create_zone_space(zone_pk, cloud_pk, ifc_pk, project_pk, data)
...
try:
    api_response = api_instance.create_zone_space(zone_pk, cloud_pk, ifc_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **delete_element**
> delete_element(uuid, cloud_pk, ifc_pk, project_pk)
...
try:
    api_instance.delete_element(uuid, cloud_pk, ifc_pk, project_pk)
except ApiException as e:
...
# **delete_ifc_property**
> delete_ifc_property(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_ifc_property(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
> delete_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
# **delete_ifc_unit**
> delete_ifc_unit(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_ifc_unit(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
# **delete_property_set**
> delete_property_set(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_property_set(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
# **delete_space**
> delete_space(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_space(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
# **delete_zone**
> delete_zone(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_instance.delete_zone(cloud_pk, ifc_pk, id, project_pk)
except ApiException as e:
...
# **delete_zone_space**
> delete_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk)
...
try:
    api_instance.delete_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk)
except ApiException as e:
...
# **full_update_element**
> Element full_update_element(uuid, cloud_pk, ifc_pk, project_pk, data)
...
try:
    api_response = api_instance.full_update_element(uuid, cloud_pk, ifc_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> ModelProperty full_update_ifc_property(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_ifc_property(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition full_update_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> Unit full_update_ifc_unit(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_ifc_unit(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> PropertySet full_update_property_set(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_property_set(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_space**
> Space full_update_space(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_space(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_zone**
> Zone full_update_zone(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.full_update_zone(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> ZoneSpace full_update_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk, data)
...
try:
    api_response = api_instance.full_update_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
...
> list[Classification] get_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk)
...
try:
    api_response = api_instance.get_classifications_of_element(element_uuid, cloud_pk, ifc_pk, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_element**
> Element get_element(uuid, cloud_pk, ifc_pk, project_pk)
...
try:
    api_response = api_instance.get_element(uuid, cloud_pk, ifc_pk, project_pk)
    pprint(api_response)
except ApiException as e:
...
> PropertySet get_element_property_set(cloud_pk, project_pk, id, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set(cloud_pk, project_pk, id, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> list[ModelProperty] get_element_property_set_properties(cloud_pk, project_pk, propertyset_pk, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set_properties(cloud_pk, project_pk, propertyset_pk, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> ModelProperty get_element_property_set_property(cloud_pk, project_pk, propertyset_pk, id, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set_property(cloud_pk, project_pk, propertyset_pk, id, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition get_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, id, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, id, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> Unit get_element_property_set_property_definition_unit(element_uuid, ifc_pk, cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, id, property_pk)
...
try:
    api_response = api_instance.get_element_property_set_property_definition_unit(element_uuid, ifc_pk, cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, id, property_pk)
    pprint(api_response)
except ApiException as e:
...
> list[Unit] get_element_property_set_property_definition_units(cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set_property_definition_units(cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> list[PropertyDefinition] get_element_property_set_property_definitions(cloud_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid)
...
try:
    api_response = api_instance.get_element_property_set_property_definitions(cloud_pk, project_pk, propertyset_pk, property_pk, ifc_pk, element_uuid)
    pprint(api_response)
except ApiException as e:
...
> list[PropertySet] get_element_property_sets(element_uuid, cloud_pk, ifc_pk, project_pk)
...
try:
    api_response = api_instance.get_element_property_sets(element_uuid, cloud_pk, ifc_pk, project_pk)
    pprint(api_response)
except ApiException as e:
...
> list[Element] get_elements_from_classification(ifc_classification_pk, cloud_pk, ifc_pk, project_pk)
...
try:
    api_response = api_instance.get_elements_from_classification(ifc_classification_pk, cloud_pk, ifc_pk, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_ifc_property**
> ModelProperty get_ifc_property(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_ifc_property(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition get_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_ifc_unit**
> Unit get_ifc_unit(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_ifc_unit(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_property_set**
> PropertySet get_property_set(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_property_set(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_space**
> Space get_space(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_space(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_zone**
> Zone get_zone(cloud_pk, ifc_pk, id, project_pk)
...
try:
    api_response = api_instance.get_zone(cloud_pk, ifc_pk, id, project_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_zone_space**
> ZoneSpace get_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk)
...
try:
    api_response = api_instance.get_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk)
    pprint(api_response)
except ApiException as e:
...
# **get_zone_spaces**
> list[ZoneSpace] get_zone_spaces(zone_pk, cloud_pk, ifc_pk, project_pk)
...
try:
    api_response = api_instance.get_zone_spaces(zone_pk, cloud_pk, ifc_pk, project_pk)
    pprint(api_response)
except ApiException as e:
...
> remove_classification_of_element(cloud_pk, project_pk, id, ifc_pk, element_uuid)
...
try:
    api_instance.remove_classification_of_element(cloud_pk, project_pk, id, ifc_pk, element_uuid)
except ApiException as e:
...
> remove_element_property_set(cloud_pk, project_pk, id, ifc_pk, element_uuid)
...
try:
    api_instance.remove_element_property_set(cloud_pk, project_pk, id, ifc_pk, element_uuid)
except ApiException as e:
...
> remove_element_property_set_property(cloud_pk, project_pk, propertyset_pk, id, ifc_pk, element_uuid)
...
try:
    api_instance.remove_element_property_set_property(cloud_pk, project_pk, propertyset_pk, id, ifc_pk, element_uuid)
except ApiException as e:
...
> remove_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, id, ifc_pk, element_uuid)
...
try:
    api_instance.remove_element_property_set_property_definition(cloud_pk, project_pk, propertyset_pk, property_pk, id, ifc_pk, element_uuid)
except ApiException as e:
...
> remove_element_property_set_property_definition_unit(element_uuid, ifc_pk, cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, id, property_pk)
...
try:
    api_instance.remove_element_property_set_property_definition_unit(element_uuid, ifc_pk, cloud_pk, propertydefinition_pk, project_pk, propertyset_pk, id, property_pk)
except ApiException as e:
...
> remove_elements_from_classification(ifc_classification_pk, cloud_pk, project_pk, uuid, ifc_pk)
...
try:
    api_instance.remove_elements_from_classification(ifc_classification_pk, cloud_pk, project_pk, uuid, ifc_pk)
except ApiException as e:
...
# **update_element**
> Element update_element(uuid, cloud_pk, ifc_pk, project_pk, data)
...
try:
    api_response = api_instance.update_element(uuid, cloud_pk, ifc_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_ifc_property**
> ModelProperty update_ifc_property(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_ifc_property(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> PropertyDefinition update_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_ifc_property_definition(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_ifc_unit**
> Unit update_ifc_unit(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_ifc_unit(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_property_set**
> PropertySet update_property_set(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_property_set(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_space**
> Space update_space(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_space(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_zone**
> Zone update_zone(cloud_pk, ifc_pk, id, project_pk, data)
...
try:
    api_response = api_instance.update_zone(cloud_pk, ifc_pk, id, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **update_zone_space**
> ZoneSpace update_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk, data)
...
try:
    api_response = api_instance.update_zone_space(cloud_pk, project_pk, id, zone_pk, ifc_pk, data)
    pprint(api_response)
except ApiException as e:
