...
Create a document. If the document is one of {'GLTF', 'PHOTOSPHERE', 'POINT_CLOUD', 'DXF', 'DWG', 'IFC', 'OBJ'}, a model will be created and attached to this document  Required scopes: document:write
