...
[**create_equipment**](ModelApi.md#create_equipment) | **POST** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment | Create an equipment on the model
...
[**get_equipment_documents**](ModelApi.md#get_equipment_documents) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{equipment_pk}/document | Retrieve all documents of an equipment
...
[**get_models_summary**](ModelApi.md#get_models_summary) | **GET** /cloud/{cloud_pk}/project/{project_pk}/model/summary | Retrieve all models summary
...
[**link_documents_to_equipment**](ModelApi.md#link_documents_to_equipment) | **POST** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{equipment_pk}/document | Link one or many documents to an equipment
...
[**remove_equipment_document**](ModelApi.md#remove_equipment_document) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{equipment_pk}/document/{id} | Remove a document from an equipment
...
[**update_equipment**](ModelApi.md#update_equipment) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/equipment/{id} | Update some fields of an equipment
...
# **add_equipment_image**
> EquipmentImage add_equipment_image(cloud_pk, equipment_pk, model_pk, project_pk, equipment_image_request)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    equipment_image_request = EquipmentImageRequest(
    ...
    try:
        # Add a new image to the equipment
        api_response = api_instance.add_equipment_image(cloud_pk, equipment_pk, model_pk, project_pk, equipment_image_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->add_equipment_image: %s\n" % e)
```
 ...
 **equipment_image_request** | [**EquipmentImageRequest**](EquipmentImageRequest.md)|  |

### Return type

[**EquipmentImage**](EquipmentImage.md)
...
# **create_equipment**
> ModelEquipment create_equipment(cloud_pk, model_pk, project_pk, model_equipment_request)

Create an equipment on the model

Create an equipment on the model  Required scopes: ifc:write, model:write
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an equipment on the model
        api_response = api_instance.create_equipment(cloud_pk, model_pk, project_pk, model_equipment_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->create_equipment: %s\n" % e)
```
 ...
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
 **model_equipment_request** | [**ModelEquipmentRequest**](ModelEquipmentRequest.md)|  |

### Return type

[**ModelEquipment**](ModelEquipment.md)
...
# **create_label**
> ModelLabel create_label(cloud_pk, model_pk, project_pk, model_label_request)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    model_pk = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | A unique integer value identifying this project.
    model_label_request = ModelLabelRequest(
        name="name_example",
        color="color_example",
        geometry=[
    ...
    try:
        # Create a label in the model
        api_response = api_instance.create_label(cloud_pk, model_pk, project_pk, model_label_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->create_label: %s\n" % e)
```
 ...
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
 **model_label_request** | [**ModelLabelRequest**](ModelLabelRequest.md)|  |
...
# **create_positioned_model**
> ModelOnModelPosition create_positioned_model(cloud_pk, model_pk, project_pk, model_on_model_position_creation_request)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add a child model and it's position on the model
        api_response = api_instance.create_positioned_model(cloud_pk, model_pk, project_pk, model_on_model_position_creation_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->create_positioned_model: %s\n" % e)
```
 ...
 **project_pk** | **int**| A unique integer value identifying this project. |
 **model_on_model_position_creation_request** | [**ModelOnModelPositionCreationRequest**](ModelOnModelPositionCreationRequest.md)|  |
...
# **delete_equipment**
> delete_equipment(cloud_pk, id, model_pk, project_pk)

Delete an equipment

Delete an equipment of the model.  Required scopes: ifc:write, model:write
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = model_api.ModelApi(api_client)
    cloud_pk = 1 # int | A unique integer value identifying this cloud.
    id = 1 # int | A unique integer value identifying this equipment.
    model_pk = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | A unique integer value identifying this project.
    ...
    try:
        # Delete an equipment
        api_instance.delete_equipment(cloud_pk, id, model_pk, project_pk)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->delete_equipment: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **cloud_pk** | **int**| A unique integer value identifying this cloud. |
 **id** | **int**| A unique integer value identifying this equipment. |
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
...
> delete_equipment_image(cloud_pk, equipment_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    cloud_pk = 1 # int | A unique integer value identifying this cloud.
    equipment_pk = 1 # int | A unique integer value identifying this equipment.
    id = 1 # int | A unique integer value identifying this equipment image.
    model_pk = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | A unique integer value identifying this project.
    ...
    try:
        # Remove an equipment image
        api_instance.delete_equipment_image(cloud_pk, equipment_pk, id, model_pk, project_pk)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->delete_equipment_image: %s\n" % e)
```
 ...
 **cloud_pk** | **int**| A unique integer value identifying this cloud. |
 **equipment_pk** | **int**| A unique integer value identifying this equipment. |
 **id** | **int**| A unique integer value identifying this equipment image. |
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
...
# **delete_label**
> delete_label(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a label
        api_instance.delete_label(cloud_pk, id, model_pk, project_pk)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->delete_label: %s\n" % e)
```
...
> delete_positioned_model(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = model_api.ModelApi(api_client)
    cloud_pk = 1 # int | A unique integer value identifying this cloud.
    id = 1 # int | A unique integer value identifying this model on model position.
    model_pk = 1 # int | ID of the host model in which {id} is positioned
    project_pk = 1 # int | A unique integer value identifying this project.
    ...
    try:
        # Remove a child model and its position from the model
        api_instance.delete_positioned_model(cloud_pk, id, model_pk, project_pk)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->delete_positioned_model: %s\n" % e)
```
...
# **get_equipment**
> ModelEquipment get_equipment(cloud_pk, id, model_pk, project_pk)

Retrieve one equipment of the model

Retrieve one equipment of the model  Required scopes: ifc:read, model:read
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve one equipment of the model
        api_response = api_instance.get_equipment(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_equipment: %s\n" % e)
```
...
> [LightDocument] get_equipment_documents(cloud_pk, equipment_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all documents of an equipment
        api_response = api_instance.get_equipment_documents(cloud_pk, equipment_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_equipment_documents: %s\n" % e)
```
...
# **get_equipment_images**
> [EquipmentImage] get_equipment_images(cloud_pk, equipment_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all images attached to the equipment
        api_response = api_instance.get_equipment_images(cloud_pk, equipment_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_equipment_images: %s\n" % e)
```
...
# **get_equipments**
> [ModelEquipment] get_equipments(cloud_pk, model_pk, project_pk)

Retrieve all equipments of the model

Retrieve all equipments of the model  Required scopes: ifc:read, model:read
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all equipments of the model
        api_response = api_instance.get_equipments(cloud_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_equipments: %s\n" % e)
```
...
# **get_label**
> ModelLabel get_label(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve one label of the model
        api_response = api_instance.get_label(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_label: %s\n" % e)
```
...
# **get_labels**
> [ModelLabel] get_labels(cloud_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    model_pk = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | A unique integer value identifying this project.
    is_validated = True # bool |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Retrieve all labels of the model
        api_response = api_instance.get_labels(cloud_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
    ...
    try:
        # Retrieve all labels of the model
        api_response = api_instance.get_labels(cloud_pk, model_pk, project_pk, is_validated=is_validated)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_labels: %s\n" % e)
```
...
# **get_models_summary**
> [LightModel] get_models_summary(cloud_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all models summary
        api_response = api_instance.get_models_summary(cloud_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_models_summary: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Retrieve all models summary
        api_response = api_instance.get_models_summary(cloud_pk, project_pk, source=source, status=status, type=type)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_models_summary: %s\n" % e)
```
...
# **get_positioned_model**
> ModelOnModelPosition get_positioned_model(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve one specific child model & position on the model
        api_response = api_instance.get_positioned_model(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_positioned_model: %s\n" % e)
```
...
# **get_positioned_models**
> [ModelOnModelPosition] get_positioned_models(cloud_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all positioned child model & positions on the model
        api_response = api_instance.get_positioned_models(cloud_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_positioned_models: %s\n" % e)
```
...
> [PropertyList] get_properties_types(cloud_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all property types and their value type used in this model
        api_response = api_instance.get_properties_types(cloud_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
...
# **get_types**
> [str] get_types(cloud_pk, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all IFC Types used in this model
        api_response = api_instance.get_types(cloud_pk, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->get_types: %s\n" % e)
```
...
# **remove_equipment_document**
> remove_equipment_document(cloud_pk, equipment_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove a document from an equipment
        api_instance.remove_equipment_document(cloud_pk, equipment_pk, id, model_pk, project_pk)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->remove_equipment_document: %s\n" % e)
```
...
# **update_equipment**
> ModelEquipment update_equipment(cloud_pk, id, model_pk, project_pk)

Update some fields of an equipment

Update some fields of an equipment.  Required scopes: ifc:write, model:write
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    ) # PatchedModelEquipmentRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Update some fields of an equipment
        api_response = api_instance.update_equipment(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_equipment: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Update some fields of an equipment
        api_response = api_instance.update_equipment(cloud_pk, id, model_pk, project_pk, patched_model_equipment_request=patched_model_equipment_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_equipment: %s\n" % e)
```
 ...
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
 **patched_model_equipment_request** | [**PatchedModelEquipmentRequest**](PatchedModelEquipmentRequest.md)|  | [optional]
...
# **update_label**
> ModelLabel update_label(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    model_pk = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | A unique integer value identifying this project.
    patched_model_label_request = PatchedModelLabelRequest(
        name="name_example",
        color="color_example",
        geometry=[
            Geometry2dPointRequest(
        ...
        human_validated=True,
    ) # PatchedModelLabelRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Update some fields of a label
        api_response = api_instance.update_label(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_label: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Update some fields of a label
        api_response = api_instance.update_label(cloud_pk, id, model_pk, project_pk, patched_model_label_request=patched_model_label_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_label: %s\n" % e)
```
 ...
 **model_pk** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**| A unique integer value identifying this project. |
 **patched_model_label_request** | [**PatchedModelLabelRequest**](PatchedModelLabelRequest.md)|  | [optional]
...
# **update_mask2_d**
> Mask2D update_mask2_d(cloud_pk, id, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    id = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | 
    patched_mask2_d_request = PatchedMask2DRequest(
        crop_path=[
            [
                3.14,
            ],
        ...
        brightness=3.14,
        contrast=3.14,
    ) # PatchedMask2DRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Partial update of a 2D mask for the model
        api_response = api_instance.update_mask2_d(cloud_pk, id, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_mask2_d: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Partial update of a 2D mask for the model
        api_response = api_instance.update_mask2_d(cloud_pk, id, project_pk, patched_mask2_d_request=patched_mask2_d_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_mask2_d: %s\n" % e)
```
 ...
 **id** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**|  |
 **patched_mask2_d_request** | [**PatchedMask2DRequest**](PatchedMask2DRequest.md)|  | [optional]
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update models file (gltf, svg, structure, etc)
        api_response = api_instance.update_model_files(cloud_pk, id, project_pk, structure_file=structure_file, systems_file=systems_file, map_file=map_file, gltf_file=gltf_file, preview_file=preview_file, xkt_file=xkt_file, fragments_file=fragments_file, binary_2d_file=binary_2d_file)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_model_files: %s\n" % e)
```
...
> Transform update_model_transform(cloud_pk, id, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    id = 1 # int | A unique integer value identifying this model.
    project_pk = 1 # int | 
    patched_transform_request = PatchedTransformRequest(
        translate=[
            3.14,
        ],
        rotate=3.14,
        scale=3.14,
        opacity=3.14,
    ) # PatchedTransformRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Update model transform
        api_response = api_instance.update_model_transform(cloud_pk, id, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_model_transform: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Update model transform
        api_response = api_instance.update_model_transform(cloud_pk, id, project_pk, patched_transform_request=patched_transform_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_model_transform: %s\n" % e)
```
 ...
 **id** | **int**| A unique integer value identifying this model. |
 **project_pk** | **int**|  |
 **patched_transform_request** | [**PatchedTransformRequest**](PatchedTransformRequest.md)|  | [optional]
...
# **update_positioned_model**
> ModelOnModelPosition update_positioned_model(cloud_pk, id, model_pk, project_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update the position of a child model on the model
        api_response = api_instance.update_positioned_model(cloud_pk, id, model_pk, project_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_positioned_model: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Update the position of a child model on the model
        api_response = api_instance.update_positioned_model(cloud_pk, id, model_pk, project_pk, patched_model_on_model_position_request=patched_model_on_model_position_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling ModelApi->update_positioned_model: %s\n" % e)
```
