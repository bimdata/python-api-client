...
[**create_document_reference**](BcfApi.md#create_document_reference) | **POST** /bcf/2.1/projects/{projects_pk}/topics/{guid}/document_references | Create a reference to a document
...
[**download_bcf_export_post**](BcfApi.md#download_bcf_export_post) | **POST** /bcf/2.1/projects/{id}/export | 
[**download_bcf_export_xlsx**](BcfApi.md#download_bcf_export_xlsx) | **GET** /bcf/2.1/projects/{id}/export-xlsx | 
[**download_bcf_export_xlsx_post**](BcfApi.md#download_bcf_export_xlsx_post) | **POST** /bcf/2.1/projects/{id}/export-xlsx | 
...
[**full_update_document_reference**](BcfApi.md#full_update_document_reference) | **PUT** /bcf/2.1/projects/{projects_pk}/topics/{guid}/document_references | Add or update document references to a topic
...
[**get_comments_events**](BcfApi.md#get_comments_events) | **GET** /bcf/2.1/projects/{projects_pk}/topics/comments/events | Get comments events
...
[**get_document_references**](BcfApi.md#get_document_references) | **GET** /bcf/2.1/projects/{projects_pk}/topics/{guid}/document_references | Retrieve all documents referenced by the topic
...
[**get_topics_events**](BcfApi.md#get_topics_events) | **GET** /bcf/2.1/projects/{projects_pk}/topics/events | Get topics events
[**get_topics_pins**](BcfApi.md#get_topics_pins) | **GET** /bcf/2.1/projects/{projects_pk}/topics/pins | Get pins of all or many topics
...
> DocumentReference create_document_reference(guid, projects_pk, document_reference_request)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a reference to a document
        api_response = api_instance.create_document_reference(guid, projects_pk, document_reference_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
 ...
 **guid** | **str**|  |
 **projects_pk** | **int**|  |
 **document_reference_request** | [**DocumentReferenceRequest**](DocumentReferenceRequest.md)|  |
...
# **download_bcf_export_post**
> file_type download_bcf_export_post(id)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    api_instance = bcf_api.BcfApi(api_client)
    id = 1 # int | A unique integer value identifying this project.
    bcf_project_export_request = BcfProjectExportRequest(
        topics=[
            "topics_example",
        ],
        format="standard",
    ) # BcfProjectExportRequest |  (optional)

    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.download_bcf_export_post(id)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->download_bcf_export_post: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.download_bcf_export_post(id, bcf_project_export_request=bcf_project_export_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->download_bcf_export_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| A unique integer value identifying this project. |
 **bcf_project_export_request** | [**BcfProjectExportRequest**](BcfProjectExportRequest.md)|  | [optional]
...
# **download_bcf_export_xlsx_post**
> file_type download_bcf_export_xlsx_post(id)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.download_bcf_export_xlsx_post(id)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->download_bcf_export_xlsx_post: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        api_response = api_instance.download_bcf_export_xlsx_post(id, locale=locale, bcf_project_export_request=bcf_project_export_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->download_bcf_export_xlsx_post: %s\n" % e)
```
...
> [DocumentReference] full_update_document_reference(guid, projects_pk, document_reference_request)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add or update document references to a topic
        api_response = api_instance.full_update_document_reference(guid, projects_pk, document_reference_request)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
    ...
    try:
        # Add or update document references to a topic
        api_response = api_instance.full_update_document_reference(guid, projects_pk, document_reference_request, format=format, ifcs=ifcs, models=models)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->full_update_document_reference: %s\n" % e)
```
...
# **get_colorings**
> ColoringDefinition get_colorings(guid, projects_pk, topics_guid)
...
# **get_comments_events**
> [CommentEvent] get_comments_events(projects_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get comments events
        api_response = api_instance.get_comments_events(projects_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_comments_events: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Get comments events
        api_response = api_instance.get_comments_events(projects_pk, filter=filter, orderby=orderby)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_comments_events: %s\n" % e)
```
...
> [DocumentReference] get_document_references(guid, projects_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve all documents referenced by the topic
        api_response = api_instance.get_document_references(guid, projects_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
    ...
    try:
        # Retrieve all documents referenced by the topic
        api_response = api_instance.get_document_references(guid, projects_pk, format=format, ifcs=ifcs, models=models)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_document_references: %s\n" % e)
```
...
# **get_selections**
> SelectionDefinition get_selections(guid, projects_pk, topics_guid)
...
# **get_topics_events**
> [TopicEvent] get_topics_events(projects_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get topics events
        api_response = api_instance.get_topics_events(projects_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_topics_events: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Get topics events
        api_response = api_instance.get_topics_events(projects_pk, filter=filter, orderby=orderby)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_topics_events: %s\n" % e)
```
...
# **get_topics_pins**
> [TopicPin] get_topics_pins(projects_pk)
...
with bimdata_api_client.ApiClient(configuration) as api_client:
    ...
    topics = "topics_example" # str | topic guids to include, comma separated. Default = all (optional)

    # example passing only required values which don't have defaults set
    try:
        # Get pins of all or many topics
        api_response = api_instance.get_topics_pins(projects_pk)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_topics_pins: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Get pins of all or many topics
        api_response = api_instance.get_topics_pins(projects_pk, format=format, ifcs=ifcs, models=models, topics=topics)
        pprint(api_response)
    except bimdata_api_client.ApiException as e:
        print("Exception when calling BcfApi->get_topics_pins: %s\n" % e)
```
...
# **get_visibilities**
> VisibilityDefinition get_visibilities(guid, projects_pk, topics_guid)
