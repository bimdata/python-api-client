...
# **create_document**
> Document create_document(cloud_pk, project_pk, data)
...
try:
    api_response = api_instance.create_document(cloud_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
# **create_project_user**
> FosUserWrite create_project_user(cloud_pk, project_pk, data)
...
try:
    api_response = api_instance.create_project_user(cloud_pk, project_pk, data)
    pprint(api_response)
except ApiException as e:
...
> delete_classification(cloud_pk, project_pk, id)
...
try:
    api_instance.delete_classification(cloud_pk, project_pk, id)
except ApiException as e:
...
# **delete_document**
> delete_document(cloud_pk, project_pk, id)
...
try:
    api_instance.delete_document(cloud_pk, project_pk, id)
except ApiException as e:
...
# **delete_folder**
> delete_folder(cloud_pk, project_pk, id)
...
try:
    api_instance.delete_folder(cloud_pk, project_pk, id)
except ApiException as e:
...
# **delete_project_user**
> delete_project_user(cloud_pk, project_pk, id)
...
try:
    api_instance.delete_project_user(cloud_pk, project_pk, id)
except ApiException as e:
...
> Classification full_update_classification(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.full_update_classification(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> Document full_update_document(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.full_update_document(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **full_update_folder**
> Folder full_update_folder(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.full_update_folder(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
> FosUserWrite full_update_project_user(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.full_update_project_user(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **get_classification**
> Classification get_classification(cloud_pk, project_pk, id)
...
try:
    api_response = api_instance.get_classification(cloud_pk, project_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_document**
> Document get_document(cloud_pk, project_pk, id)
...
try:
    api_response = api_instance.get_document(cloud_pk, project_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_folder**
> Folder get_folder(cloud_pk, project_pk, id)
...
try:
    api_response = api_instance.get_folder(cloud_pk, project_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_project_user**
> FosUser get_project_user(cloud_pk, project_pk, id)
...
try:
    api_response = api_instance.get_project_user(cloud_pk, project_pk, id)
    pprint(api_response)
except ApiException as e:
...
# **get_project_users**
> list[FosUser] get_project_users(cloud_pk, project_pk)
...
> Classification update_classification(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.update_classification(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_document**
> Document update_document(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.update_document(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_folder**
> Folder update_folder(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.update_folder(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
...
# **update_project_user**
> FosUserWrite update_project_user(cloud_pk, project_pk, id, data)
...
try:
    api_response = api_instance.update_project_user(cloud_pk, project_pk, id, data)
    pprint(api_response)
except ApiException as e:
