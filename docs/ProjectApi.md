...
# **create_project_user**
> InviteUser create_project_user(cloud_pk, project_pk, data)
...
> InviteUser full_update_project_user(cloud_pk, id, project_pk, data)
...
# **update_project_user**
> InviteUser update_project_user(cloud_pk, id, project_pk, data)
