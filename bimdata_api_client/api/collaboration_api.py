...
class CollaborationApi(object):
    ...
    def create_document(
        ...
        **kwargs
        ...
        Create a document. If the document is one of {'OBJ', 'GLTF', 'DXF', 'POINT_CLOUD', 'IFC', 'DWG'}, a model will be created and attached to this document  Required scopes: document:write  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
