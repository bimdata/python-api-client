...
class ModelOnModelPositionRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, position, *args, **kwargs):  # noqa: E501
        """ModelOnModelPositionRequest - a model defined in OpenAPI
