...
class ModelEquipmentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, position, *args, **kwargs):  # noqa: E501
        """ModelEquipmentRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, position, *args, **kwargs):  # noqa: E501
        """ModelEquipmentRequest - a model defined in OpenAPI
