...
class PatchedDocumentRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'model_source': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'ifc_source': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            model_source (bool, date, datetime, dict, float, int, list, str, none_type): Define the model.source field if the upload is a Model (IFC, PDF, DWG...). [optional]  # noqa: E501
            ifc_source (bool, date, datetime, dict, float, int, list, str, none_type): DEPRECATED: Use 'model_source' instead. Define the model.source field if the upload is a Model (IFC, PDF, DWG...). [optional]  # noqa: E501
        """
