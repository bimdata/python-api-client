...
class Invitation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cloud_role': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'email': (str,),  # noqa: E501
            'project_name': (str,),  # noqa: E501
            'project_role': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, client_id, redirect_uri, cloud_name, cloud_role, email, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            project_role (bool, date, datetime, dict, float, int, list, str, none_type): Role the user will have when they accept the invitation. [optional]  # noqa: E501
            status (bool, date, datetime, dict, float, int, list, str, none_type):          A: Accepted         D: Denied         P: Pending         . [optional]  # noqa: E501
