...
def lazy_import():
    ...
    globals()['ManagedByEnum'] = ManagedByEnum
...
class Size(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'is_unsupervised': (bool,),  # noqa: E501
            'managed_by': (ManagedByEnum,),  # noqa: E501
            'role': (CloudRoleEnum,),  # noqa: E501
    ...
    attribute_map = {
        'is_unsupervised': 'is_unsupervised',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_unsupervised, managed_by, role, total_size, smart_data_size, total_size_available, smart_data_size_available, remaining_total_size, remaining_smart_data_size, remaining_total_size_percent, remaining_smart_data_size_percent, *args, **kwargs):  # noqa: E501
        """Size - a model defined in OpenAPI

        Args:
            is_unsupervised (bool):
            managed_by (ManagedByEnum):
            role (CloudRoleEnum):
