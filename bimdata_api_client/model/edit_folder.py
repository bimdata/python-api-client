...
class EditFolder(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, id, groups_permissions, updated_at, created_by, created_at, user_permission, nature, name, conflicting_documents, *args, **kwargs):  # noqa: E501
