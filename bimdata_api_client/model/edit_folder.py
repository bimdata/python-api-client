...
class EditFolder(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, id, created_at, groups_permissions, nature, user_permission, updated_at, created_by, name, conflicting_documents, *args, **kwargs):  # noqa: E501
